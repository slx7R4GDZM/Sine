...
private:
    ...
    void draw(const u8 direction, const bool draw_thrust, Vector_Generator& vector_generator, RenderWindow& window) const;
...
public:
    ...
    void update(const u8 fast_timer, const u8 direction, Offset explosion_x[], Offset explosion_y[], const bool thrusting, Vector_Generator& vector_generator, RenderWindow& window);
