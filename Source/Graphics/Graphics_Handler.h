...
public:
    ...
    static void draw_number(const u16 number, const u8 rightmost_x, const u8 y, const Global_Scale num_scale, Vector_Generator& vector_generator, sf::RenderWindow& window, const bool add_zero = false, const bool brighten = false);
    ...
    static void set_position_and_size(const u8 cur_x, const u8 cur_y, const Global_Scale scale, Vector_Generator& vector_generator, sf::RenderWindow& window);
};
